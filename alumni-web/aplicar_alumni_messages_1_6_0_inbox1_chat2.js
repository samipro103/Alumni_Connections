...
const MARKER = "ALUMNI_MESSAGES_1_6_0_INBOX1_CHAT2";
...
let inbox = fs.readFileSync(inboxFile, "utf8");
let chat = fs.readFileSync(chatFile, "utf8");
let group = fs.readFileSync(groupFile, "utf8");
...
console.log("");
console.log("✅ ALUMNI Messages 1.6.0 aplicado COMPLETO.");
