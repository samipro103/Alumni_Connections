...
const MARKER = "ALUMNI_STORIES_THEME_1_4_4_CLEAN_PUBLISH_DUAL_THEME";
...
if (composer.includes("<Send")) {
  console.error("❌ Validación: todavía quedó un icono Send en StoryComposer.");
  process.exit(1);
}
...
console.log("");
console.log("✅ ALUMNI Stories/Theme 1.4.4 aplicado COMPLETO.");
console.log("✅ Sin modal final de publicación.");
console.log("✅ CTA final: Publicar.");
console.log("✅ Sin icono raro de publicar.");
