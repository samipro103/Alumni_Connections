    ...
    <div className="alumni-account-trust">
      <Panel>
        ...
        <div className="mt-5 border-y border-[var(--app-border)] py-4">
          ...
          <p className="mt-1 break-all text-sm text-[var(--app-text-soft)]">
            {email ||
      ...
      <Panel>
        ...
        <button
          ...
          disabled={exporting}
          className="mt-4 flex h-10 items-center gap-2 text-xs font-black text-[var(--app-accent)] disabled:opacity-50"
        >
          {exporting ? (
            <Loader2
              size={15}
        ...
        <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 border-t border-[var(--app-border)] pt-4 text-xs font-bold text-[var(--app-muted-2)]">
          <Link
            href="/legal/privacy"
            className="hover:text-[var(--app-text-soft)]"
          >
            Privacidad
          </Link>
          <Link
      ...
      <Panel>
        ...
        <button
          type="button"
          onClick={logout}
          className="mt-4 flex h-10 items-center gap-2 text-xs font-black text-[var(--app-muted)] transition hover:text-[var(--app-text)]"
        >
          <LogOut size={15} />
          Cerrar sesión
        </button>
      ...
      {accountFlow && (
        ...
        >
          <section className="alumni-account-flow-sheet w-full max-w-[470px] overflow-hidden">
