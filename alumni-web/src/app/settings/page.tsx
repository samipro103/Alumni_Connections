...
export default function SettingsPage() {
  ...
  if (loadingProfile) {
    return (
      <AppShell>
        <div className="alumni-settings-loading py-16 text-center text-sm text-[var(--app-muted-2)]" data-alumni-motion-ignore="true">
...
function PrivacyModeModal({
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="alumni-settings-privacy-modal w-full max-w-[460px] p-5 pb-[max(20px,env(safe-area-inset-bottom))] sm:p-6">
...
function Panel({
  ...
  return (
    <div className="alumni-settings-panel rounded-[18px] border border-[var(--app-border)] bg-[var(--app-surface)] p-4 sm:p-5">
      {children}
    </div>
  );
}
    ...
    <div className="space-y-5">
      <Panel>
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 rounded-xl border border-white/[0.07] bg-white/[0.025] px-4 py-3 text-sm text-[var(--app-text-soft)]">
      ...
      <Panel>
        ...
        <p className="mt-1 text-xs leading-5 text-[var(--app-muted-3)]">
...
function Field({
  ...
  return (
    <label className="block">
      <span className="mb-2 block text-xs font-bold text-[var(--app-muted-2)]">
        {label}
      </span>
      {children}
    </label>
...
function SocialField({
  ...
  return (
    <label className="flex items-center gap-3 rounded-2xl border border-white/[0.07] bg-white/[0.025] px-4 transition hover:bg-white/[0.04]">
      <span className="text-[var(--app-muted-3)]">
        {icon}
      </span>

      <div className="min-w-0 flex-1">
        <span className="block pt-2 text-[10px] font-bold uppercase tracking-[0.12em] text-[var(--app-muted-3)]">
          {label}
        </span>
        ...
        <input
          ...
          className="h-9 w-full bg-transparent text-sm text-[var(--app-text-soft)] outline-none placeholder:text-[var(--app-muted-3)]"
          placeholder={`${label}...`}
        />
      </div>
    </label>
