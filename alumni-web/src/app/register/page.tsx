        ...
        <section className="flex items-center justify-center px-5 py-12 sm:px-8">
          <div className="w-full max-w-md">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              Tu perfil Alumni comienza con lo esencial.
            </p>
            ...
            <form onSubmit={handleRegister} className="mt-8 space-y-4">
              ...
              <button
                ...
                className="mt-2 h-12 w-full rounded-2xl bg-[#6d7cff] text-sm font-black transition hover:bg-[#7b87ff] disabled:cursor-not-allowed disabled:bg-white/[0.06] disabled:text-zinc-700"
              >
...
/* ALUMNI_RESTORE_STABLE_DIRECT_SIGNUP */
